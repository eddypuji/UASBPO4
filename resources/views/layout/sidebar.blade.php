...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="{{ asset('') }}" class="brand-link">
    <img src="dist/img/logo.png" alt="kangDisen Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    <span class="brand-text font-weight-light">kangDisen Studio</span>
  </a>
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      ...
      <div class="info">
        <a href="{{ asset('') }}" class="d-block">Eddy Pujiallo</a>
      </div>
    </div>
